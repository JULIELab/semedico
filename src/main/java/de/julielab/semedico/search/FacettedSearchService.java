...
public class FacettedSearchService implements IFacettedSearchService {
	...
	public FacettedSearchService(int maxFacettedDocuments, int maxDocumentHits) {
		super();
	...
	public FacettedSearchResult search(
		...
		// OpenBitSet limitizedDocuments = documentSetLimitizerService
		// .limitDocumentSetWithIncludedScoreDocs(documents,
