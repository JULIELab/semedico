...
import de.julielab.semedico.core.search.components.data.DocumentIdSearchResult;
 ...
 * 
 */
public class DocumentIdPreparationComponent extends AbstractSearchComponent {

	@Retention(RetentionPolicy.RUNTIME)
	public @interface DocumentIdPreparation {
		//
	}

	public DocumentIdPreparationComponent(Logger log) {
		super(log);
	}
	...
	public boolean processSearch(SearchCarrier searchCarrier) {
		SemedicoSearchCarrier<ISemedicoQuery, DocumentIdSearchResult> semCarrier =  (SemedicoSearchCarrier<ISemedicoQuery, DocumentIdSearchResult>) searchCarrier;
