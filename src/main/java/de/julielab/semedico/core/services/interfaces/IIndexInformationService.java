...
public interface IIndexInformationService {
	...
	public static final Set<String> conceptFields = Sets.newHashSet(Indexes.Documents.mesh,
			Indexes.Documents.conceptlist);
	public static final Set<String> noConceptFields = Sets.newHashSet(Indexes.Documents.docmeta,
			Indexes.Documents.authors
