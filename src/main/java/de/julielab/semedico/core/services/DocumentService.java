...
public class DocumentService implements IDocumentService {
	...
	public DocumentService(IDocumentCacheService documentCacheService, IHighlightingService kwicService,
	...
	protected void readPublications(SemedicoDocument document, ISearchServerDocument solrDoc) {
		...
		if (!StringUtils.isBlank(dateString)) {
			...
			if (solrDoc.getIndexType().equals(IIndexInformationService.Indexes.DocumentTypes.pmc)
		...
		for (ISearchServerDocument innerDoc : innerStatementHits) {
			...
			Predicate<Object> isTermIdPredicate = new Predicate<Object>() {
				...
				public boolean apply(Object input) {
					return termService.isTermID((String) input);
				}
