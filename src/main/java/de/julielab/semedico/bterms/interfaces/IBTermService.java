...
public interface IBTermService {
	public List<Label> determineBTermLabelList(List<Multimap<String, IFacetTerm>> searchNodes) throws TooFewSearchNodesException, EmptySearchComplementException;
}
