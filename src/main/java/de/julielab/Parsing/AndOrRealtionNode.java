 ...
 *
 */
public class AndOrRealtionNode extends NonTerminalNode{
	...
	private AndOrRealtionNode leftChild;
	private AndOrRealtionNode rightChild;
	...
	public void setParent(AndOrRealtionNode parent) {
		this.parent = parent;
	}

	private AndOrRealtionNode parent;
	 ...
	 *            Text in the leaf.
	 */
	public AndOrRealtionNode(String text) {
	 ...
	 */
	public AndOrRealtionNode(NodeType type, AndOrRealtionNode child) {
	 ...
	 */
	public AndOrRealtionNode(NodeType type, AndOrRealtionNode left, AndOrRealtionNode right) {
	 ...
	 *            Right child/subtree of the node
	 */
	public AndOrRealtionNode(NodeType type, String text, AndOrRealtionNode left, AndOrRealtionNode right) {
...
//	}
	 ...
	 */
	public AndOrRealtionNode getParent() {
		return parent;
	}
	 ...
	 */
	public AndOrRealtionNode getLeftChild() {
		return leftChild;
	}
	 ...
	 */
	public AndOrRealtionNode getRightChild() {
		return rightChild;
	}
	 ...
	 *            Child to remove.
	 */
	void removeChild(AndOrRealtionNode child) {
		if (child == leftChild)
			leftChild = null;
	 ...
	 */
	void replaceChild(AndOrRealtionNode oldChild, AndOrRealtionNode newChild){
	 ...
	 */
	void setRightChild(AndOrRealtionNode child) throws Exception {
		if (type != NodeType.TEXT)
			rightChild = child;
		else
	 ...
	 *             If node has type text.
	 */
	void setLeftChild(AndOrRealtionNode child) throws Exception {
		if (type != NodeType.TEXT)
			leftChild = child;
		else
			throw new Exception("Text nodes must not have children.");
	...
	public String recursiveToString(AndOrRealtionNode node) {
