...
public class TerminalNode {
	...
	private TerminalNode leftChild;
	private TerminalNode rightChild;
	 ...
	 */
	public TerminalNode(NodeType type, TerminalNode child) {
	 ...
	 */
	public TerminalNode(NodeType type, TerminalNode left, TerminalNode right) {
	 ...
	 *            Right child/subtree of the node
	 */
	public TerminalNode(NodeType type, String text, TerminalNode left, TerminalNode right) {
...
//	}
	 ...
	 */
	public TerminalNode getLeftChild() {
		return leftChild;
	}
	 ...
	 */
	public TerminalNode getRightChild() {
		return rightChild;
	}
	 ...
	 */
	void replaceChild(TerminalNode oldChild, TerminalNode newChild){
	 ...
	 */
	void setRightChild(TerminalNode child) throws Exception {
		if (type != NodeType.TEXT)
			rightChild = child;
		else
	 ...
	 *             If node has type text.
	 */
	void setLeftChild(TerminalNode child) throws Exception {
		if (type != NodeType.TEXT)
			leftChild = child;
		else
			throw new Exception("Text nodes must not have children.");
	...
	public String recursiveToString(TerminalNode node) {
