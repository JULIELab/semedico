...
public class OpenBitSet implements Cloneable, Serializable, Iterable<Integer> {
  protected long[] bits;
  protected int wlen;   // number of words (elements) used in the array
  
  private class OpenBitSetIterator implements Iterator<Integer>{
