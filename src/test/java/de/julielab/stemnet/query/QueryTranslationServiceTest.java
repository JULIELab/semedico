...
import de.julielab.stemnet.query.QueryTranslationService;
...
public class QueryTranslationServiceTest {
	...
	public void testCreateQueryForTerm() throws Exception {
		...
		Collection<String> indexNames2 = Lists.newArrayList("fieldName3",
				"fieldName4");
		Facet facet1 = new Facet("facet1");

		FacetTerm term = new FacetTerm();
		term.setIndexNames(indexNames1);
		term.setInternalIdentifier("internal_identifier_1");
		term.setFacet(facet1);

		FacetTerm termWithMinus = new FacetTerm();
		termWithMinus.setIndexNames(indexNames1);
		termWithMinus.setInternalIdentifier("-keyword_identifier");
		termWithMinus.setFacet(FacetService.KEYWORD_FACET);

		FacetTerm phraseQueryTerm = new FacetTerm();
		phraseQueryTerm.setIndexNames(indexNames2);
		phraseQueryTerm.setInternalIdentifier("phrase query");
		...
		// mesh:D00043 text:D00043 (SolrQuery; meaning: Return documents
		// containing in the field "mesh" the (Lucene) Term D00043 OR in the
		// field "text" the (Lucene) Term D00043 (assuming OR is the default
		// operator configured in solr.xml)
		assertEquals(
				"(fieldName1:internal_identifier_1 fieldName2:internal_identifier_1)",
				solrQuery);
		...
		assertEquals(
				"(fieldName1:\"-keyword_identifier\" fieldName2:\"-keyword_identifier\")",
				solrQuery);
		...
		assertEquals(
				"(fieldName3:\"phrase query\"~2 fieldName4:\"phrase query\"~2)",
				solrQuery);
	...
	public void testCreateQueryForTerms() throws Exception {
		...
		Collection<String> indexNames2 = Lists.newArrayList("fieldName3",
				"fieldName4");
		Facet facet1 = new Facet("facet1");
		Facet facet2 = new Facet("facet2");

		FacetTerm term1 = new FacetTerm();
		term1.setIndexNames(indexNames1);
		term1.setInternalIdentifier("internal_identifier_1");
		term1.setFacet(facet1);

		FacetTerm term2 = new FacetTerm();
		term2.setIndexNames(indexNames1);
		term2.setInternalIdentifier("internal_identifier_2");
		term2.setFacet(facet1);

		FacetTerm term3 = new FacetTerm();
		term3.setIndexNames(indexNames1);
		term3.setInternalIdentifier("internal_identifier_3");
		...
		// of facet terms.
		Multimap<String, FacetTerm> dQuery = LinkedHashMultimap.create();
		...
		assertEquals(
				"((fieldName1:internal_identifier_1 fieldName2:internal_identifier_1) "
						+ "(fieldName1:internal_identifier_2 fieldName2:internal_identifier_2)) AND "
						+ "(fieldName1:internal_identifier_3 fieldName2:internal_identifier_3) AND "
