...
public class DictionaryReaderServiceTest  extends TestCase{
	...
	protected void setUp() throws Exception {
		super.setUp();
		dictionaryReaderService = new DictionaryReaderService(READ_DICTIONARY_FILE_PATH);
	}
	...
	public void testGetTrieDictionary() throws Exception{
		TrieDictionary<String> dictionary = dictionaryReaderService.getTrieDictionary();
		assertEquals(9, dictionary.size());
