...
public class ConceptTermToNeo4jConsumer extends JCasAnnotator_ImplBase {
	...
	private Map<Type, JCoReFeaturePath> fpMap;
	@Deprecated
	...
	public static final String ADD_WRITING_VARIANTS_ENDPOINT = "db/data/ext/" + "TermManager"
...
//		}
	...
	private void commitWritingVariants() {
		...
		try {
			...
			data.put("termVariants", gson.toJson(variantsMap));
			data.put("termAcronyms", gson.toJson(acronymsMap));
			post.setEntity(new StringEntity(gson.toJson(data), Charset.forName("UTF-8")));
