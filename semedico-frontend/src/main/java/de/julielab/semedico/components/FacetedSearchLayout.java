...
public class FacetedSearchLayout extends Search
{
	 ...
	 */
	protected void drillDownFacetConfigurations(Collection<IHierarchicalConcept> terms, Map<Facet, UIFacet> facetConfigurations)
	{

		for (IHierarchicalConcept searchTerm : terms)
		{
