...
public class ConceptRelationKey {
	private String startId;
	private String endId;
	private String relationType;
	
	public ConceptRelationKey(String startId, String endId, String incomingType) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConceptRelationKey other = (ConceptRelationKey) obj;
