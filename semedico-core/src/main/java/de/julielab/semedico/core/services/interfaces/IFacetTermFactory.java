...
public interface IFacetTermFactory {
	...
	/**
	 * Creates a keyword term, i.e. a term that has no record in the term database. Thus, its just an ordinary word,
	 * without any knowledge about synonyms, writing variants or a taxonomic structure.
	 * 
	 * @param id
	 *            The actual Lucene term that should be searched for in the index. For keyword terms, this is most
	 *            commonly just the stemmed form of the term to match the token processing for the index.
	 * @param name
	 *            The written form of the term - or word - as it occurred in the user query.
	 * @return
	 */
