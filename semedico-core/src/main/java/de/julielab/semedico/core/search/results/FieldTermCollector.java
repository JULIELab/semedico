...
public class FieldTermCollector extends SearchResultCollector<FieldTermsRetrievalResult> {

	private Collection<String> aggregationNames;

	public FieldTermCollector(Object name, Collection<String> aggregationNames) {
		super(name);
