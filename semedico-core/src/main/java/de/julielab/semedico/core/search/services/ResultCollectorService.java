...
public class ResultCollectorService implements IResultCollectorService {
	...
	@Override
	public FieldTermCollector getFieldTermsCollector(String collectorName, String... aggregationNames) {
		return new FieldTermCollector(collectorName, Arrays.asList(aggregationNames));
	}

	@Override
	public FieldTermCollector getFieldTermsCollector(String collectorName, AggregationRequest... requests) {
