 ...
 */
public class DocumentQuery extends DocumentSpanQuery {

	private Set<String> searchFieldFilter;

	public DocumentQuery(ParseTree query, String index) {
		super(query, index, SearchScope.DOCUMENTS);
		this.resultSize = 10;
	}
	
	public DocumentQuery(ParseTree query, String index, Set<String> searchFieldFilter) {
		this(query, index);
		this.searchFieldFilter = searchFieldFilter;
	}

	public DocumentQuery(ParseTree query, String index, AggregationRequest... aggregationRequests) {
		this(query, index, Collections.emptySet());
		putAggregationRequest(aggregationRequests);
	}

	public DocumentQuery(ParseTree query, String index, Collection<String> requestedFields) {
		this(query, index, Collections.emptySet());
		this.requestedFields = requestedFields;
	}

	public DocumentQuery(ParseTree query, String index, Stream<String> requestedFields,
	...
	public DocumentQuery(ParseTree query, String index, String... requestedFields) {
		this(query, index);
