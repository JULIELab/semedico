...
public class Facet implements Comparable<Facet> {
	...
	public static final Facet KEYWORD_FACET = new Facet(NodeIDPrefixConstants.FACET + "-1", "Keyword", "keywords");

	public static final Facet CORE_TERMS_FACET = new Facet(NodeIDPrefixConstants.FACET + "-2", "Special Terms", "specialterms");

	public static final Facet MOST_INFORMATIVE_CONCEPTS_FACET = new Facet(NodeIDPrefixConstants.FACET + "-3", "Most Informative Concepts", "mostinformative");
	public static final Facet MOST_FREQUENT_CONCEPTS_FACET = new Facet(NodeIDPrefixConstants.FACET + "-4", "Most Frequent Concepts", "mostfrequent");
	static {
	...
	public static final Facet BOOLEAN_OPERATORS_FACET = new Facet(NodeIDPrefixConstants.FACET + "-3", "Boolean Operators", "booleanoperators");
	...
	public UIFacet getUiFacetCopy() {
		return new UIFacet(this);
	}
