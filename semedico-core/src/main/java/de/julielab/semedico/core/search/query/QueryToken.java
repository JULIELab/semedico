...
public class QueryToken implements Comparable<QueryToken> {
	...
	/**
	 * Returns the lexer type, assigned during early input parsing. The respective constants are defined in {@link de.julielab.semedico.core.services.query.QueryTokenizerImpl}.
	 * @return An integer constant indicating the lexer type of this query token, e.g. alphanumerical, dash, phrase...
	 */
	public int getType() {
		return type;
	}
