...
public class ConceptCreator implements IConceptCreator {
    ...
    @Override
    public IHierarchicalConcept createConceptFromDescription(ConceptDescription description, Class<? extends IHierarchicalConcept> conceptClass) throws ConceptCreationException {
		IHierarchicalConcept concept;
		try {
