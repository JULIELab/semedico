...
public interface ITermService extends IStringTermService {
	 ...
	 */
	Map<String, List<Concept>> assureFacetRootsLoaded(Map<Facet, List<String>> requestRootIds) throws ConceptLoadingException, ConceptCreationException;

	void loadChildrenOfTerm(Concept facetTerm, String termLabel);

	/**
	 * Returns terms special to the system and not (necessarily) contained in a
	 * used terminology. Such terms are of mostly general semantic like
	 * "any event argument" or "any argument type" which are important to the
	 * basic mechanics of Semedico.
	 * 
	 * @return
	 */
