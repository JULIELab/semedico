...
public abstract class BaseConceptService implements ITermService {
	...
	protected Map<String, CoreConcept> coreTermsById;
	protected Map<CoreConcept.CoreTermType, CoreConcept> coreTermsByType;
	...
	private void createCoreTerms() {
		Map<CoreConcept.CoreTermType, CoreConcept> coreTermsByType = new HashMap<>();

		int specialTermId = 0;

		CoreConcept anyEventArgument = new CoreConcept(CORE_TERM_PREFIX + specialTermId++, "Any term");
		anyEventArgument
		...
		anyEventArgument.setCoreTermType(CoreConcept.CoreTermType.ANY_TERM);
		coreTermsByType.put(CoreConcept.CoreTermType.ANY_TERM, anyEventArgument);
...
//				anyMolecularInteraction);
		...
		List<CoreConcept> specialTermsList = Arrays.<CoreConcept> asList(anyEventArgument
//				,				anyMolecularInteraction
				);
		Map<String, CoreConcept> coreTermsById = new HashMap<>();
		for (CoreConcept term : specialTermsList) {
	...
	@Override
	public CoreConcept getCoreTerm(CoreTermType type) {
